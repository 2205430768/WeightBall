...
Paint paint;
	...
	case MotionEvent.ACTION_DOWN:
		if(x>xyoffsetEvent[26][0]&&x<xyoffsetEvent[26][0]+TP_ARRAY[26].getWidth()*screenScaleResult.ratio&&//如果音乐打开按钮
		...
		else if(x>xyoffsetEvent[26][0]&&x<xyoffsetEvent[26][0]+TP_ARRAY[26].getWidth()*screenScaleResult.ratio&&//如果音效打开按钮
	...
	else if(x>xyoffsetEvent[26][0]&&x<xyoffsetEvent[26][0]+TP_ARRAY[26].getWidth()*screenScaleResult.ratio&&//如果震动打开按钮
